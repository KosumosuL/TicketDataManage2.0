        ...
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>用户管理</h1>
                    <p>支持管理员对用户的各种操作</p>
                    <p><a class="btn btn-lg btn-primary" href="login.jsp" role="button">进入</a></p>
                </div>
            </div>
        </div>
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>工作票管理</h1>
                    <p>支持用户对工作票的各种操作</p>
                    <p><a class="btn btn-lg btn-primary" href="login_u.jsp" role="button">进入</a></p>
                </div>
            </div>
        </div>
        <div class="item">
...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <h2>用户管理</h2>
            <p>管理员管理用户</p>
            <p><a class="btn btn-default" href="login.jsp" role="button">进入 &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
            <img class="img-circle" src="bkimg/4.jpg" alt="Generic placeholder image" width="140" height="140">
            <h2>工作票管理</h2>
            <p>用户管理工作票数据</p>
            <p><a class="btn btn-default" href="login_u.jsp" role="button">进入 &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
